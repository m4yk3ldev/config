...
require("user.plugins.colorized") -- Cargando Colorized
require("user.plugins.cmp") -- Cargando CMP
require("user.plugins.autopairs") -- Cargando autopairs
require("user.plugins.comment") -- Cargando autopairs
require("user.plugins.gitsigns") -- Cargando user.racion de GIT
...
require("user.plugins.github") -- Cargando github copilot 
